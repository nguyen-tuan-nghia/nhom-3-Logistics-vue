...
var _default = {
  ...
  actions: {
    GetAllPermission: function GetAllPermission(_ref) {
      ...
      _axios["default"].get('/api/csPermission/index').then(function (res) {
    ...
    getPagePermission: function getPagePermission(_ref2, page) {
      ...
      _axios["default"].get('/api/csPermission/index?page=' + page).then(function (res) {
        commit('GetAllPermission', res.data.data_all);
      })["catch"](function (err) {
        console.log(err);
      });
    ...
    searchItem: function searchItem(_ref3, playload) {
      ...
      _axios["default"].get('/api/csPermission/index', {
        params: playload
      }).then(function (res) {
        console.log(res.data);
        commit('GetAllPermission', res.data.data_all);
