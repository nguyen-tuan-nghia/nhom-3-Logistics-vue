                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ feeshipSum | moneyFormat }} VND</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
export default {
    ...
    methods: {
        ...
        fillall(){
            this.axios.get('/api/admin/statistic/fillall').then(res=>{
                console.log(res);
            ...
            this.axios
                ...
                .then((res) => {
                    ...
                    res.data.forEach((element) => {
                        ...
                        this.feeshipSum += element.feeship;
                    });
                    this.datacollection = {
                        labels: date,
                        datasets: [
        ...
        findSelect() {
            ...
            this.feeshipSum=0;
            this.axios
                .post("/api/admin/statistic/findSelect", {
                    day: this.itemsday,
                })
                .then((res) => {
                    console.log(res.data);
        ...
        findDate() {
            ...
            this.feeshipSum=0;
            this.axios
                .post("/api/admin/statistic/findDate", {
                    date: this.date,
                    date2: this.date2,
                })
                .then((res) => {
