            ...
            <table class="table">
              ...
              <tbody>
                <tr v-for="(User, index) in GetAllUser.data" :key="index">
                  ...
                  <td>
                    <a @click="edit(User)"><v-icon>mdi-pencil</v-icon></a>
                  </td>
                  <td>
                    <a @click="deleteUser(User)"><v-icon>mdi-delete</v-icon></a>
                  </td>
                </tr>
              </tbody>
            </table>
            <nav aria-label="...">
              <ul class="pagination">
                <li
                  class="page-item"
                  :class="{
                    disabled: GetAllUser.prev_page_url == null,
                  }"
                >
                  <a
                ...
                <li
                  ...
                  class="page-item"
                  :class="{
                    active: GetAllUser.current_page == n,
                  }"
                  aria-current="page"
                >
                ...
                <li
                  class="page-item"
                  :class="{
                    disabled: GetAllUser.next_page_url == null,
                  }"
                >
                  <a
                    @click="PageChange(GetAllUser.current_page + 1)"
...
export default {
  ...
  mounted() {
    const GetAllUser = { permission: this.$route.params.name };
  ...
  methods: {
    ...
    update(){
      ...
      this.axios
        .post(`/api/User/update/${this.edit_id}`, play)
        .then((res) => {
            for(let n in this.GetAllUser.data)
              if( this.GetAllUser.data[n].id == res.data.id){
                  this.GetAllUser.data[n].name=res.data.name;
                  this.GetAllUser.data[n].emai=res.data.email;
                  this.GetAllUser.data[n].phone=res.data.phone;
              }
    ...
    submit() {
      ...
      this.axios
        .post("/api/User/add", play)
        .then((res) => {
          console.log(res.data);
          this.GetAllUser.data.unshift(res.data.data);
          this.GetAllUserID.data.unshift(res.data.data);
          this.flashMessage.success({
            title: "message",
