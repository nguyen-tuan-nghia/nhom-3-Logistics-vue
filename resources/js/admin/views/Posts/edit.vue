...
export default {
    ...
    sanitizeTitle: function(title) {
      ...
      return this.slug=slug;
        ...
        getEdit(){
        this.axios.get(`/posts/edit/${this.$route.params.id}`).then((res)=>{
            console.log(res.data);
            this.title=res.data.data.title;
            this.keywords=res.data.data.keywords.split(',');;
            this.content=res.data.data.content;
            this.select=res.data.data.status;
            this.imageEdit=res.data.data.image;
        ...
        submit() {
            ...
            this.axios
                .post(`/api/update/posts/${this.$route.params.id}`, app)
                .then((res) => {
                    ...
                    this.$router.push({name:'listAdminPosts'});
                })
                .catch((err) => {
