                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <router-link :to="{name:'registerCustomer'}" class="small" >Create an Account!</router-link>
                                    </div>
                                    <div class="text-center">
                                        <router-link :to="{name:'adlogin'}" class="small" >Employee login here !</router-link>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    methods:{
        login(){
            ...
            this.axios.post('/api/login/customer',payload)
            .then(res=>{
