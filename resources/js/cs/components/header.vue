<template>
                ...
                <label class="switch">
                    <input type="checkbox" @change="switchTheme" id="customSwitch1">
                    <span class="slider round"></span>
                </label>
<!-- <div class="custom-control custom-switch">
  <input type="checkbox" @change="switchTheme" class="custom-control-input" id="customSwitch1">
  <label class="custom-control-label" for="customSwitch1">Dask theme</label>
</div> -->
                    <!-- Topbar Search -->
                    <form
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <router-link class="dropdown-item" :to="{name:'csSetting'}">
...
export default({
    ...
    methods:{
        ...
        let element = document.querySelector('#accordionSidebar');
        if(DarkMode=='true'){
